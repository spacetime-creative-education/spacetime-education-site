    ...
    return (
      <div className="pricing-table">
        ...
        <div className="pricing-content">
          ...
          <a href="https://s3.ap-south-1.amazonaws.com/spacetime-education/Syllabus.pdf" className="download-syllabus-link" download><div className="download-syllabus">Download syllabus
