            ...
            <div className="row row-2">
              ...
              <div className="box section-how">
                ...
                <Parallax className="box section-how-desc" offsetXMax="0px" offsetXMin="50px">
                  <h3 className="welcome-text"><i>Introducing a <span style={{'text-decoration':'line-through'}}>Revolutionary</span>Nah... Not so much. Introducing a fun take on learning to code in python! Let's establish good coding practices, and get ready to become a full-stack developer, or implement your ideas with Machine Learning.</i></h3>
                </Parallax>
